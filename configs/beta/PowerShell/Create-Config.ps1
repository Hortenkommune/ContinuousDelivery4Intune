$PowerShell = @(
    ...
    @{
        ...
        Command   = "`$Username = (Get-WMIObject -class Win32_ComputerSystem | Select-Object -ExpandProperty Username); `$Username = `$Username -replace `"SKOLE\\`",`"`"; Remove-Item `"C:\Users\`$Username\OneDrive - Horten kommune\desktop.ini`" -Force"
