...
$ScriptLocURI = "https://raw.githubusercontent.com/Hortenkommune/ContinuousDelivery4Intune/SkyFunctions/install/CD4Intune.ps1"
...
$ScheduledTaskVersion = "[BETA] SkyFunctions"
