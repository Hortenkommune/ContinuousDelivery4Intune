...
if($Users -eq "AsgardenSA") {
    ...
    Add-Printer -Name "Asgarden (Lønneveien) - Printer" -PortName "Asgarden(Lønneveien)" -DriverName $PrinterDriver 
    Add-Printer -Name "Asgarden (Nygårdsløkka) - Printer" -PortName "Asgarden(Nygårdsløkka)" -DriverName $PrinterDriver
}
...
if($Users -eq "BlaberlyngenSA") {
    ...
    Add-Printer -Name "Blaberlyngen - Printer" -PortName "Blaberlyngen" -DriverName $PrinterDriver 
    Add-Printer -Name "Blaberlyngen(Gang) - Printer" -PortName "Blaberlyngen(Gang)" -DriverName $PrinterDriver
}
